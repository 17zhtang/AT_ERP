...
public class H0406_0020 extends _H0406 implements TestCase {
    public H0406_0020() {
    }

    public H0406_0020(WebDriver driver) {
        super(driver);
    }

    @Override
    public void testcase() throws Exception {
        String sheetname = H0406_0020.class.getPackage().getName().split("\\.")[4];
