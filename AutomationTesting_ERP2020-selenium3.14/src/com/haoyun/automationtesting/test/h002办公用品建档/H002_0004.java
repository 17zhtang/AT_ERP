 ...
 * @author 
 */
public class H002_0004 extends _H002 implements TestCase {
	public H002_0004() {
	}

	public H002_0004(WebDriver driver) {
		super(driver);
	}
