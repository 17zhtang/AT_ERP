...
/***
 * @用例名称:设备管理-设备列表--按设备名称查询（前置用例H710_0010）
 * @author Linjf
 */

public class H710_0050 extends _H710 implements TestCase {
	public H710_0050(){
		super();
	}
	public H710_0050(WebDriver driver){
		super(driver);
	}
	
	@Override
	public void testcase() throws Exception{
		String sheetname = H710_0050.class.getPackage().getName().split("\\.")[4];
