 ...
 *
 */
public class _H1001 extends action {
	...
	public _H1001(WebDriver driver) {
		super(driver);

	}

	/* 下面为页面所有元素 */
	/* * 点击仓库管理-仓库设置-仓库基本信息管理*/
	public static void step1() throws Exception {
		PM.return_sy();
		PM.menu_text("仓库管理");
		PM.menu_text("仓库设置");
		PM.menu_text("仓库基本信息管理");
	}

	/**
	 * 业务步骤 新建仓库
	 * @例子 h090110_CKXJ("自动化基础数据", "自动化343564场景名称", "自动化343564场景名称", "是", "开")
	 * 
	 * @param ckmc
	 *            :仓库名称
	 * @param ckbm
